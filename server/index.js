//const uri = "mongodb+srv://mern-book-store:p5Wcni4gh3lKJJlF@cluster0.lasbpba.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
...
async function run() {
    try {
        ...
        //Create POST endpoint to save an order:
        app.post("/place-order", async (req, res) => {
          ...
          // Create GET endpoint to retrieve orders for a user
